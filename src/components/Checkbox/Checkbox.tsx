...
function MinusIcon(props: React.ComponentProps<'svg'>) {
    return (
        <svg fill="none" width="10" height="10" viewBox="0 0 24 24" stroke="currentcolor" strokeWidth="3" strokeLinecap="round" aria-hidden {...props}>
...
>(({ className, ...props }, ref) => (
    <BaseCheckbox.Root
        ref={ref}
        className={cn(
            'flex size-5 shrink-0 items-center justify-center rounded-sm border border-pecan/30 bg-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky focus-visible:ring-offset-2 data-[checked]:border-sky data-[checked]:bg-sky data-[indeterminate]:border-sky data-[indeterminate]:bg-sky data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50',
            className
        )}
        {...props}
    />
...
export const CheckboxIndicator = React.forwardRef<
    HTMLSpanElement,
    React.ComponentPropsWithoutRef<typeof BaseCheckbox.Indicator> & { indeterminate?: boolean }
