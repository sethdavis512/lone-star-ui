...
function ChevronUpDownIcon(props: React.ComponentProps<'svg'>) {
    return (
        <svg width="8" height="12" viewBox="0 0 8 12" fill="none" stroke="currentcolor" strokeWidth="1.5" aria-hidden {...props}>
...
>(({ className, ...props }, ref) => (
    <BaseSelect.Value
        ref={ref}
        className={cn('data-[placeholder]:text-pecan/40', className)}
        {...props}
    />
));
...
>(({ className, children, ...props }, ref) => (
    <BaseSelect.Icon
        ref={ref}
        className={cn('flex text-pecan/50', className)}
        {...props}
    >
...
>(({ className, ...props }, ref) => (
    <BaseSelect.GroupLabel
        ref={ref}
        className={cn('px-3 py-1.5 text-xs font-semibold uppercase tracking-wide text-pecan/50', className)}
        {...props}
    />
));
...
>(({ className, ...props }, ref) => (
    <BaseSelect.ScrollUpArrow
        ref={ref}
        className={cn(
            'top-0 z-[1] flex h-4 w-full cursor-default items-center justify-center text-pecan/50 before:absolute before:inset-x-0 before:h-full before:content-[""]',
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <BaseSelect.ScrollDownArrow
        ref={ref}
        className={cn(
            'bottom-0 z-[1] flex h-4 w-full cursor-default items-center justify-center text-pecan/50 before:absolute before:inset-x-0 before:h-full before:content-[""]',
            className
        )}
        {...props}
    />
